...
<html>
	...
	<body>
		<div id="container">
			...
			<div class="textbody">
				<p>I was born in Melbourne, did high school in Singapore, and am now at Stanford University (currently on leave!)<br>🌲🇦🇺🇸🇬🇺🇸</p>
				...
				<p>In high school, I made random things — notably software products, music covers, and long articles — a lot of times with <a class="tag" href="http://lenny.io">Lenny Khazan</a> and other friends. I also took a two-year philosophy class in school that I think was the best choice I've ever made.</p>
			...
			<div class="textbody">
				<ul>
          <li>making, building, creating products: ideas, code & design!</li>
				  <li>music: playing shows & making songs. vocals, guitars, & bass. <a class="tag" href="https://open.spotify.com/user/1178095932/playlist/3TQiiVqXiXh9MbgVxN8vxw?si=LYSKpIf_RTyY4SGLIFrMfg">punk</a> especially :)</li>
          <li>writing: fiction, articles, guides, essays, w/e!</li>
			...
			<div class="textbody">
				<ul>
				  <li>always be creating, always be performing</li>
          <li>contribute to + learn about problems I care about</li>
				  <li>work for myself & <a href="https://open.spotify.com/track/32rUsiLCvd1yZWr4UFUoiu?si=LlsHsXqpTgmxqi6VflVISw">stay free</a>. mischief forever :)</li>
				</ul>
			</div>
			...
			<div class="textbody">
			  	<ul>
	          <li><a href="https://i.imgur.com/m64vOLK.jpg">built a little DIY music studio in my room :)</a></li>
            ...
            <li><a href="http://www.fullvolumeonly.com">Full Volume Only</a>: young san francisco noisemakers, playing shows & crafting tunes 🤘🏻🎸</li>
			  		...
			  		<li>open source stuff and weekend hacks on my <a class="tag" href="http://GitHub.com/MCKapur">GitHub</a></li>
						...
						<li>spent my first year at Stanford reading and thinking about life + purpose, which culminated to this <a href="https://mckapur.quip.com/a97YA7st1HU7/Narrative-Identity">"Narrative Identity"</a> essay</li>
